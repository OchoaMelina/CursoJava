...
public class Principal extends JFrame implements ActionListener{
    ...
    public Principal(){
      ...
      miCreador.setFont(new Font("Arial",1,14));
      ...
      labelBienvenido.setFont(new Font("Arial Blak", 1, 32));
      ...
      txtNombreTrabajador.setBackground(new Color(244,244,244));
      ...
      txtAPaternoTrabajador.setBackground(new Color(244,244,244));
      ...
      txtAMaternoTrabajador.setBackground(new Color(244,244,244));
      ...
      textarea1.setFont(new Font("Arial",1,14));
      textarea1.setForeground(new Color(255,0,0));
      textarea1.setText("\n Aquí aparece el resultado del calculo de las vacaciones.");
      scrollpane1 = new JScrollPane(textarea1);
      scrollpane1.setBounds(220,337,385,90);
      add(scrollpane1);
    ...
    public void actionPerformed(ActionEvent e){
       ...
       if(e.getSource() == miCreador){
          ...
          JOptionPane.showMessageDialog(null, "\n  Desarrollado por Ochoa Melina\n" + 
                                              "    melinaochoa.93@gmail.com");
       }
    }
